 ...
 */
export function GoodsRfqForm({ categories, states, defaults, prefill }: { categories: GoodsRfqCategoryOption[]; states: { value: string; label: string }[]; defaults: DeliveryDefaults | null; prefill: GoodsRfqPrefill | null }) {
