 ...
 * (E16 N41 — records only, never money). Inert while MART_ENABLED=false:
...
export async function GET(request: NextRequest) {
  ...
  const result = { ...closed, ...settled, promiseOrders: promises.orders, promiseBreaches: promises.breaches }
