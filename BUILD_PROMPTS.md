...
> - **Built dark:** S3.4 (ADR 024, `docs/agents/AGGREGATION.md`). Its volume tiers reuse the E12b design rules. Migration 0071 is applied
>   to production (2026-09-24). Enabling waits for the V1.5→V2 gate.
