...
| Rate limiting | **No-op without Upstash** — not in local env names; prod unverified. Cold-start warning exists (`rate-limit.ts:24-27`) | `UPSTASH_REDIS_REST_URL/TOKEN` | Verify set in Vercel (must-do; protects OTP/SMS bill and paid AI) |
